...
const partidosData = [
    ...
    { id: 85, fase: "16vos", grupo: "Eliminatoria", fecha: "Viernes 03/07/2026", local: "1B", visita: "3T1" },
...
function actualizarLogicaAdmin() {
    ...
    const mapeo16vos = [
        ...
        { id: 80, l: clasificados['1L'], v: clasificados['2H'] || "2H" },
        ...
        { id: 87, l: clasificados['1J'], v: clasificados['3T4'] },
